...
<div class="page-master">
  <div class="container">
    ...
    <div class="content-page">
      <p>
        Please review these terms and conditions of use carefully before using <a href="{{url('/')}}">i1mp3.com</a>, including, without limitation, the following websites:
        </p>
        <p>
        This document states the terms and conditions („Terms”) upon which i1mp3.com („we” or „us”) will provide service to you on its websites, including, without limitation,
        the above listed websites (collectively, the „Website”). These Terms constitute a contractual agreement between you and us. By visiting, accessing, using, and/or joining (collectively „using”)
        the Website, you express your understanding and acceptance of these Terms. As used in this document, the terms „you” or „your” refers to you, any entity you represent, your or its
        representatives, successors, assigns and affiliates, and any of your or their devices. If you do not agree to be bound by these Terms, navigate away from the Website and cease using it.
        </p>
        <h2>1. Eligibility</h2>
        <ul>
        ...
        <ul>
        <li>We retain a separate <a href="{{url('/')}}/privacy-policy">Privacy Policy</a> and your assent to these Terms also signifies your assent to the <a href="{{url('/')}}/privacy-policy">Privacy Policy</a>. We reserve the right to amend the <a href="{{url('/')}}/privacy-policy">Privacy Policy</a> at any time by posting such amendments to the Website. No other notification may be made to you about any amendments. Your continued use of the Website following such amendments will constitute your acceptance of such amendments, regardless of whether you have actually read them.</li>
        </ul>
        ...
        <li class="b">REPEAT INFRINGER POLICY.  AS PART OF OUR REPEAT-INFRINGEMENT POLICY, ANY USER FOR WHOSE MATERIAL WE RECEIVE THREE GOOD-FAITH AND EFFECTIVE COMPLAINTS WITHIN ANY CONTIGUOUS SIX-MONTH PERIOD WILL HAVE HIS GRANT OF USE OF THE WEBSITE TERMINATED.</li>
        <li>Although we are not subject to United States law, we voluntarily comply with the Digital Millennium Copyright Act. Pursuant to Title 17, Section 512(c)(2) of the United States Code, if you believe that any of your copyrighted material is being infringed on the Website, we have designated an agent to receive notifications of claimed copyright infringement. Notifications should be e-mailed to info@i1mp3.com</div></li>
        ...
        <li>If your User Submission or a search result to your website is removed pursuant to a notification of claimed copyright infringement, you may provide us with a counter-notification, which must be a written communication to our above listed agent and satisfactory to us that includes substantially the following:
         <ul>
          ...
          <li>Your name, address, telephone number, email address and a statement that you consent to the jurisdiction of the courts in the address you provided, Anguilla and the location(s) in which the purported copyright owner is located; and</li>
        ...
        <ul>
        <li>We reserve the right to amend these Terms at any time by posting such amended Terms to the Website. No other notification may be made to you about any amendments. YOU ACKNOWLEDGE THAT YOUR CONTINUED USE OF THE WEBSITE FOLLOWING SUCH AMENDMENTS WILL CONSTITUTE YOUR ACCEPTANCE OF SUCH AMENDMENTS, REGARDLESS OF WHETHER YOU HAVE ACTUALLY READ THEM.</li>
        </ul>
        ...
        <ul>
        <li>To the maximum extent permitted by law, these Terms as well as any claim, cause of action, or dispute that may arise between you and us, are governed by the laws of Anguilla without regard to conflict of law provisions. FOR ANY CLAIM BROUGHT BY YOU AGAINST US, YOU AGREE TO SUBMIT AND CONSENT TO THE PERSONAL AND EXCLUSIVE JURISDICTION IN, AND THE EXCLUSIVE VENUE OF THE COURTS IN ANGUILLA.  FOR ANY CLAIM BROUGHT BY US AGAINST YOU, YOU AGREE TO SUBMIT AND CONSENT TO PERSONAL JURISDICTION IN AND THE VENUE OF THE COURTS IN ANGUILLA AND ANYWHERE ELSE YOU CAN BE FOUND. You hereby waive any right to seek another venue because of improper or inconvenient forum.</li>
        ...
        <li class="b">You hereby agree that as part of the consideration for these terms, you are hereby waiving any right you may have to a trial by jury for any dispute between the us arising from or relating to these terms or the Website.  This provision shall be enforceable even in the case that any arbitration provisions or any other provisions of this section are waived.</li>
        </ul>
